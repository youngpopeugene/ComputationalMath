...
public class Reader {
    ...
    public static int methodInput() {
        ...
        System.out.println(Printer.getYellowText("3. Решение методом Адамса"));
    ...
    public static int functionSelection() {
        ...
        System.out.println(Printer.getYellowText("1. 6x^2 + 5xy"));
        System.out.println(Printer.getYellowText("2. x + cos(y / sqrt(5))"));
